...
$.ajax({
  ...
  for (let index = 0; index < response.length; index++) {
    var mes=moment(response[index].fields.Fecha_Venta)
    var objFinal = new Object();
    objFinal.Fecha = mes.format('MMMM')
    objFinal.costo = response[index].fields.PrecioVenta
